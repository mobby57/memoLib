...
# ⚠️ IMPORTANT: Remplacer les valeurs YOUR_* par vos vrais secrets
...
$vars = @{
    ...
    "NEXTAUTH_SECRET" = "YOUR_NEXTAUTH_SECRET_HERE"  # Générer: openssl rand -base64 32
    "NEXTAUTH_URL" = "https://your-app.pages.dev"
    "SENDGRID_API_KEY" = "YOUR_SENDGRID_API_KEY_HERE"
    "SENDGRID_SENDER_EMAIL" = "contact@your-domain.com"
