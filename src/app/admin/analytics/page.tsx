      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="mb-8">
          ...
          <p className="text-gray-600">
            Real-time insights into revenue, engagement, emails, and analysis performance
          </p>
        </div>
        ...
        <div className="bg-white rounded-lg shadow mb-6">
          ...
          <div className="p-6">
            ...
            {activeTab === 'engagement' && (
              <EngagementTab data={engagementData} stats={stats?.engagement} />
            )}
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        ...
        <MetricBox label="Précision d'Analyse" value={`${(stats?.aiAccuracy || 0).toFixed(1)}%`} />
      </div>
    </div>
  );
}
