...
const PUBLIC_ROUTES = [
  ...
  { path: '/logiciel-avocat', changeFrequency: 'monthly' as const, priority: 0.9 },
  { path: '/gestion-cabinet-avocat', changeFrequency: 'monthly' as const, priority: 0.8 },
  { path: '/oqtf-delais-recours', changeFrequency: 'monthly' as const, priority: 0.8 },
