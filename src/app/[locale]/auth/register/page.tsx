 ...
 * Permet aux avocats de cr�er un compte et un cabinet
 */
...
const PLANS = [
  {
    ...
    name: 'Solo',
    price: 49,
    description: 'Avocat ind�pendant',
  ...
  },
  {
    ...
    features: ['100 clients', '300 dossiers', '5 utilisateurs', '50 GB stockage', 'IA avanc�e'],
    recommended: true,
  },
  {
    id: 'ENTERPRISE',
    ...
    features: ['Clients illimit�s', 'Dossiers illimit�s', 'Utilisateurs illimit�s', '500 GB stockage', 'API PISTE', 'Support d�di�'],
    recommended: false,
  },
]
              ...
              <div className="space-y-4">
                ...
                <label className="flex items-start gap-3 cursor-pointer">
                  ...
                  <span className="text-sm text-gray-600">
                    ...
                    {' '}qui d�finit les r�gles d&apos;utilisation de l&apos;IA et garantit que les d�cisions critiques restent sous contr�le humain.
                  </span>
                </label>
              </div>
            </div>
