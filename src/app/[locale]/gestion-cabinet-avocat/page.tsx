    ...
    <div className="min-h-screen bg-white">
      ...
      <section className="bg-indigo-900 py-16">
        <div className="max-w-4xl mx-auto px-6 text-center">
          ...
          <Link href="/fr/auth/register?plan=PILOT" className="px-8 py-4 bg-white text-indigo-900 font-semibold rounded-xl hover:bg-indigo-50 transition-colors inline-flex items-center gap-2">
