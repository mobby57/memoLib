...
export default function FacturesPage() {
  ...
  const columns = [
    ...
    },
    {
      ...
      header: 'Montant HT',
      render: (value: number) => `${value.toFixed(2)} e`,
    },
    {
    ...
    <div className="p-6 space-y-6 animate-fadeIn">
        ...
        <div className="relative z-10 flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
          <div>
            ...
            <p className="text-emerald-100 mt-2 max-w-lg">
              CA Total: {stats.total.toFixed(2)} e - Dont {stats.montantPaye.toFixed(2)} e encaisse
            </p>
          </div>
      ...
      <Card>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
          {/* Barre de progression CA encaisse */}
          ...
          <div className="p-4 bg-blue-50 dark:bg-blue-900/20 rounded-xl">
            <div className="flex justify-between items-center mb-2">
              ...
              <span className="text-sm font-bold text-blue-700 dark:text-blue-300">
                {stats.montantEnAttente.toFixed(2)} e
              </span>
            </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
        ...
        <div className="transform hover:scale-105 transition-transform duration-300">
          <StatCard
            title="Montant paye"
            value={`${stats.montantPaye.toFixed(2)} e`}
            icon={CheckCircle}
          />
        </div>
        <div className="transform hover:scale-105 transition-transform duration-300">
          <StatCard
            title="En attente"
            value={`${stats.montantEnAttente.toFixed(2)} e`}
            icon={Clock}
          />
        </div>
        <div className="transform hover:scale-105 transition-transform duration-300">
