      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
          ...
          <div className="bg-gradient-to-br from-blue-500 to-blue-600 rounded-lg shadow-lg p-6 text-white">
            ...
            <p className="text-3xl font-bold">{stats.totalMRR.toLocaleString('fr-FR')}e</p>
          ...
          <div className="bg-gradient-to-br from-green-500 to-green-600 rounded-lg shadow-lg p-6 text-white">
            ...
            <p className="text-3xl font-bold">{stats.totalARR.toLocaleString('fr-FR')}e</p>
              ...
              <div key={plan.planName} className="border-2 border-gray-200 rounded-lg p-6">
                ...
                <div className="space-y-2">
                  <div className="flex items-center justify-between">
                    ...
                    <span className="font-semibold text-gray-900">{plan.priceMonthly}e/mois</span>
                  </div>
                  <div className="flex items-center justify-between">
                    <span className="text-sm text-gray-600">MRR de ce plan</span>
                    <span className="font-semibold text-green-600">
                      {plan.mrr.toLocaleString('fr-FR')}e
                    </span>
                  </div>
                  <div className="flex items-center justify-between">
          ...
          <div className="bg-white rounded-lg shadow-md p-6">
            ...
            <div className="space-y-3">
              <div className="flex items-center justify-between p-3 bg-gray-50 rounded">
                ...
                <span className="text-lg font-bold text-blue-600">3 490e</span>
              </div>
              <div className="flex items-center justify-between p-3 bg-gray-50 rounded">
                <span className="text-sm font-medium text-gray-700">Objectif Moyen Terme</span>
                <span className="text-lg font-bold text-purple-600">20 000e</span>
              </div>
              <div className="flex items-center justify-between p-3 bg-gray-50 rounded">
                <span className="text-sm font-medium text-gray-700">Objectif Long Terme</span>
                <span className="text-lg font-bold text-green-600">150 000e</span>
              </div>
            </div>
            ...
            <div className="space-y-3">
              <div className="p-3 border border-gray-200 rounded">
                <div className="flex items-center justify-between mb-1">
                  ...
                  <span className="text-green-600 font-bold">3 490e</span>
                </div>
              ...
              <div className="p-3 border border-gray-200 rounded">
                <div className="flex items-center justify-between mb-1">
                  ...
                  <span className="text-blue-600 font-bold">19 945e</span>
                </div>
              ...
              <div className="p-3 border border-gray-200 rounded">
                <div className="flex items-center justify-between mb-1">
                  ...
                  <span className="text-purple-600 font-bold">94 750e</span>
                </div>
