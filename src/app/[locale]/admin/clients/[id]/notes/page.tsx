            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
              ...
              <div>
                ...
                <p className="text-lg font-semibold text-gray-900">
                  {subscription.pricePerMonth}e/mois
                </p>
              </div>
              <div>
            ...
            {plans.map((plan) => (
              ...
              >
                ...
                <div className="text-center mb-6">
                  <p className="text-4xl font-bold text-gray-900">{plan.priceMonthly}e</p>
                  <p className="text-sm text-gray-600">par mois</p>
                  <p className="text-sm text-gray-500 mt-1">
                    {plan.priceYearly}e/an (economie de {Math.round((1 - plan.priceYearly / (plan.priceMonthly * 12)) * 100)}%)
                  </p>
                </div>
