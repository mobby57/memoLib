  ...
  if (loading) {
    return (
      <div className="flex items-center justify-center h-screen">
        ...
        <span className="ml-2 text-gray-600">Chargement des donn�es multi-canal...</span>
      </div>
    );
  }
      ...
      <div className="bg-white border-b px-6 py-4">
        <div className="flex items-center justify-between">
          <div>
            ...
            <p className="text-gray-500 mt-1">Tous vos canaux de communication centralis�s</p>
          </div>
        ...
        <div className="flex items-center gap-4">
          ...
          <div className="flex items-center gap-2">
            ...
            >
              ...
              <option value="RECEIVED">Re�u</option>
              <option value="PROCESSING">En traitement</option>
              <option value="PROCESSED">Trait�</option>
              <option value="FAILED">�chou�</option>
        ...
        <div className="space-y-4">
          ...
          {selectedMessage && (
            <div className="bg-white rounded-xl shadow-sm border p-4">
              <h3 className="font-semibold text-gray-900 mb-3">D�tails du message</h3>
              <div className="space-y-3">
                ...
                <div>
                  <label className="text-xs text-gray-500">Exp�diteur</label>
                ...
                <div>
                  <label className="text-xs text-gray-500">R�sum� IA</label>
                  <p className="text-sm text-gray-700">
                    {selectedMessage.aiAnalysis?.summary || 'Pas de r�sum� disponible'}
                  </p>
                </div>
          ...
          <div className="bg-white rounded-xl shadow-sm border p-4">
            <h3 className="font-semibold text-gray-900 mb-3">R�partition par canal</h3>
