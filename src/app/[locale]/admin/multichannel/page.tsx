  ...
  if (loading) {
    return (
      <div className="flex items-center justify-center h-screen">
        ...
        <span className="ml-2 text-gray-600">Chargement des donnees multi-canal...</span>
      </div>
    );
  }
      ...
      <div className="bg-white border-b px-6 py-4">
        <div className="flex items-center justify-between">
          <div>
            ...
            <p className="text-gray-500 mt-1">Tous vos canaux de communication centralises</p>
          </div>
        ...
        <div className="flex items-center gap-4">
          ...
          <div className="flex items-center gap-2">
            ...
            >
              ...
              <option value="RECEIVED">Reeu</option>
        ...
        <div className="space-y-4">
          ...
          {selectedMessage && (
            <div className="bg-white rounded-xl shadow-sm border p-4">
              <h3 className="font-semibold text-gray-900 mb-3">Details du message</h3>
              <div className="space-y-3">
                ...
                <div>
                  <label className="text-xs text-gray-500">Expediteur</label>
                ...
                <div>
                  <label className="text-xs text-gray-500">Resume IA</label>
                  <p className="text-sm text-gray-700">
                    {selectedMessage.aiAnalysis?.summary || 'Pas de resume disponible'}
                  </p>
                </div>
          ...
          <div className="bg-white rounded-xl shadow-sm border p-4">
            <h3 className="font-semibold text-gray-900 mb-3">Repartition par canal</h3>
