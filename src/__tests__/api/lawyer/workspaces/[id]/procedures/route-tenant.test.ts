...
const { prismaMock } = vi.hoisted(() => ({
  prismaMock: {
    procedure: { findFirst: vi.fn(), findMany: vi.fn(), update: vi.fn(), create: vi.fn() },
    workspace: { findFirst: vi.fn() },
  },
}));
vi.mock('@/lib/prisma', () => ({ default: prismaMock, prisma: prismaMock }));
import * as route from '@/app/api/lawyer/workspaces/[id]/procedures/route.ts';
...
describe('IDOR — api/lawyer/workspaces/[id]/procedures/route.ts', () => {
